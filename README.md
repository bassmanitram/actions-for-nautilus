...
The version is in the [v2](https://github.com/bassmanitram/actions-for-nautilus/tree/v2) branch, the [latest v2 pre-release]
(https://github.com/bassmanitram/actions-for-nautilus/releases/tag/v2.0.0.pre1-1) release, and the associated 
