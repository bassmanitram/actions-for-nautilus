...
const infoText = {
	...
	"#command:show_if_true": { "text": "A shell command that should be executed to establish if this action will be displayed. Click for more info.", "help_label": "show-if-true" },
