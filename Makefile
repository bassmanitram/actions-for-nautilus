...
install:
	...
	[ -f ~/.local/share/nautilus-python/extensions/actions-for-nautilus/config.json ] || cp ~/.local/share/nautilus-python/extensions/actions-for-nautilus/sqmple-config.json ~/.local/share/nautilus-python/extensions/actions-for-nautilus/config.json
	cp -a configurator/* ~/.local/share/actions-for-nautilus-configurator
	cp -a ~/.local/share/actions-for-nautilus-configurator/actions-for-nautilus-configurator.desktop ~/.local/share/applications
